...
class ApplicationsController extends \CodeDay\Clear\Http\Controller {
    ...
    public function postNew()
    {
        ...
        setcookie("readme_app", json_encode(["token" => $application->public, "secret" => $application->private]), time()+3600, null, "*.clear.codeday.org");
