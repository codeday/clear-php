...
class ShippingController extends \CodeDay\Clear\Http\Controller {
    ...
    public function postIndex()
    {
        ...
        } elseif (\Input::get('past')) {
            $event->ship_name = $event->previous_event->ship_name;
            $event->ship_company = $event->previous_event->ship_company;
            $event->ship_address_1 = $event->previous_event->ship_address_1;
            $event->ship_address_2 = $event->previous_event->ship_address_2;
            $event->ship_city = $event->previous_event->ship_city;
            $event->ship_state = $event->previous_event->ship_state;
            $event->ship_postal = $event->previous_event->ship_postal;
            $event->ship_country = $event->previous_event->ship_country;
            $event->ship_is_residential = $event->previous_event->ship_is_residential;
        } else {
